    ...
    <div class="container-form-r">
        <div class="container-edit">
            ...
            <div class="top">
                ...
                <small>Aqui puedes Agregar a tu personal, recuerda llenar todos los campos!</small>
            </div>
            ...
            while ($datos = $sql->fetch_object()) { ?>
                ...
                <form action="" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="hidden" name="id" class="form-control" id="id" placeholder="Ingrese su Nombre"
                            value="<?= $_GET['id'] ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="surname" class="form-control" id="surname" value="<?= $datos->surname ?>"
                            required>
                    </div>

                    <div class="mb-3">
                        <label for="recipient-name" class="col-form-label">Cliente</label>
                        <input type="text" name="customer" class="form-control" id="customer" value="<?= $datos->customer ?>"
                            required>
                    </div>

                    <div class="mb-3">
                        <label for="recipient-name" class="col-form-label">Email</label>
                        <input type="email" name="email" class="form-control" id="email" value="<?= $datos->email ?>"
                            required>
                    </div>

                    <div class="mb-3">
                        <label for="recipient-name" class="col-form-label">Cargo</label>
                        <input type="text" name="cargo" class="form-control" id="cargo" value="<?= $datos->cargo ?>"
                            required>
                    </div>

                    <div class="mb-3">
                        <label for="recipient-name" class="col-form-label">DTP</label>
                        <input type="text" name="departamento" class="form-control" id="departamento"
                            value="<?= $datos->departamento ?>" required>
                    </div>

                    <div class="mb-3">
                        <label for="recipient-name" class="col-form-label">Clave</label>
                        <input type="password" name="password" class="form-control" id="password"
                            value="<?= $datos->password ?>" required>
                    </div>

                    <div class="mb-3">
                        <label for="recipient-name" class="col-form-label">Roll</label>
                        <select name="roll" id="roll" class="form-select form-select-lg mb-3"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="location" class="form-control" id="location" value="<?= $datos->location ?>"
                            required>
                    </div>
            ...
            ?>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><a
                            href="../registro.php">Volver</a></button>
